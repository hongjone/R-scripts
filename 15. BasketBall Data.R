...
#need to put drop=F, so that it can be consistent and returns a matrix instead of vectors when 1 line is being returned
...
#set function to take in the data to see
...
#set a default value of the rows to show everything when not specified
